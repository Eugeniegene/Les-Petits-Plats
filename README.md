...
- Utilisez 2 branches différentes : [algoFunc](https://jsben.ch/6NSzL) et [algoLoop](https://jsben.ch/6NSzL)
- Créer un [schéma](https://github.com/git504/Les-Petits-Plats/tree/main/assets/docde) l'enchaînement des étapes de chacun des algorithmes
